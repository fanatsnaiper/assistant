...
def main(): 
    try:
        ...
        os.system("nothing_works.bat")   # тут должен вызываться .bat файл для проверки целотсности окружения приложения и вывода осведомительной информации пользователю
