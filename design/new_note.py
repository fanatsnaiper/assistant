...
# Form implementation generated from reading ui file 'new_note.ui'
#
...
class Ui_window(object):
    def setupUi(self, window):
        ...
        self.save_note_button.setGeometry(QtCore.QRect(650, 0, 150, 50))
    ...
    def retranslateUi(self, window):
        ...
        window.setWindowTitle(_translate("window", "Новая заметка"))
        ...
        self.save_note_button.setText(_translate("window", "Сохранить"))
